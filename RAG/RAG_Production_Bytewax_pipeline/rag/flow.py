...
from rag.models import ChunkedPost, CleanedPost, EmbeddedChunkedPost, RawPost
#from rag.qdrant import QdrantVectorOutput
...
def build(in_memory: bool = False):
    ...
    stream = op.input("input", flow, JSONSource(["data/pdf.json"]))
    print(stream)
